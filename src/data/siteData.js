...
export const SPONSORS = [
  {
    ...
    logo: '/public/Sponsors/CredO.jpeg',
  },
  {
    id: 2,
    name: 'EECI Gate Academy',
    tier: 'Co-Sponsor',
    tagline: 'Best GATE Coaching in Chennai',
    // white bg, deep teal text
    logo: '/public/Sponsors/eeci_gate.jpeg',
  },
  {
    id: 3,
    name: 'Bell Institute of Hotel Management',
    tier: 'Co-Sponsor',
    tagline: 'Hotel management institute in Tadagannai Managaseri, Tamil Nadu',
    // white bg, deep indigo text
    logo: '/public/Sponsors/bell_institute.jpeg',
  },
  {
    id: 4,
    name: 'Farmleys',
    tier: 'Gold',
    logo: '/public/Sponsors/Farmley_Makha_Shaka.png',
  },
  {
    id: 5,
    name: 'FinEdge',
