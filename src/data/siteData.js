...
export const BENEFITS = [
  {
    title: 'Access to All Speaker Sessions',
    desc: 'Hear directly from accomplished voices across diverse fields.',
    icon: 'mic',
  },
  {
    title: 'Real Stories & New Perspectives',
    desc: 'Learn from the successes, failures, risks and turning points behind extraordinary journeys.',
    icon: 'lightbulb',
  },
  {
    title: 'Networking Opportunities',
    desc: 'Connect with fellow students, speakers and like minded individuals.',
    icon: 'users',
  },
  {
    title: 'Lunch Included',
    desc: 'Enjoy a specially arranged lunch as part of your SYCON experience.',
    icon: 'utensils',
  },
  {
    title: 'Refreshments Throughout the Day',
    desc: 'Stay energised with refreshments during the event.',
    icon: 'coffee',
  },
  {
    title: 'Interactive Experiences',
    desc: 'Ask questions, participate in conversations and engage directly with the speakers.',
    icon: 'message-circle',
  },
]
...
export const SPEAKERS = [
  {
    ...
    tier: 'top',
    bio: 'K. Abdul Nabeel is the founder of Arabian Garden, a growing multi location restaurant chain. Starting with just 4 tables and 16 chairs in Kalpakkam , he spent years building and refining systems that transformed a small outlet into a 27 location business across South India.',
  ...
  },
  {
    ...
    tier: 'top',
    bio: 'Deepak Kumar known as “The Community Man,” is a serial entrepreneur and community builder focused on creating meaningful connections among people. He has built multiple ventures, including C3 Community and THE DNA Network, supporting creators, founders and ambitious professionals.',
  ...
  },
  {
    ...
    tier: 'top',
    bio: 'Tharun Kumar is a fitness entrepreneur, coach and athlete and the founder of Fitx120, an online fitness and body transformation venture. He has built Fitx120 around helping people achieve sustainable fat loss, muscle gain, and body recomposition through structured fitness and nutrition programs.',
  ...
  },
  {
    ...
    tier: 'bottom',
    bio: 'Vishal Nandakumar is a cybersecurity entrepreneur and the Founder & CEO of CredO, an AI driven security intelligence company focused on proactive enterprise security. With around 15 years of cybersecurity experience, he has worked across enterprise security, product development, compliance, threat intelligence and security architecture.',
  ...
  },
  {
    ...
    tier: 'bottom',
    bio: 'Shalini Robert is a young social entrepreneur and the founder of The Roberts Trust Foundation, dedicated to creating meaningful social impact. Driven by personal experience, she transformed adversity into an entrepreneurial mission focused on empowering underprivileged communities, women and children.',
  ...
  },
  {
    ...
    tier: 'bottom',
    bio: 'Hari Prasath S. is a young entrepreneur and the founder of Mahathaan, a Chennai based technology venture. His entrepreneurial journey is driven by curiosity, creativity, innovation and a strong sense of community. Through Mahathaan, he focuses on using technology to develop meaningful solutions that address real world needs.',
