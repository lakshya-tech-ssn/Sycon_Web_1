...
export const ICONS = {
  ...
  users: (p) => (
    <svg {...base} {...p}>
      ...
      <path d="M22 20c0-2.6-1.9-4.7-4.5-5.4" />
    </svg>
  ),
  ...
  trophy: (p) => (
    <svg {...base} {...p}>
      ...
      <path d="M8 4H4v2a4 4 0 0 0 4 4M16 4h4v2a4 4 0 0 1-4 4" />
      <path d="M12 12v4M8 21h8M9 21v-3h6v3" />
    </svg>
  ),
  ...
  gift: (p) => (
    <svg {...base} {...p}>
      ...
      <path d="M12 8C9 8 8 6.5 8 5a2.5 2.5 0 0 1 4-2c0 0 0 3 0 5Zm0 0c3 0 4-1.5 4-3a2.5 2.5 0 0 0-4-2c0 0 0 3 0 5Z" />
    </svg>
  ),
  ...
  utensils: (p) => (
    <svg {...base} {...p}>
      ...
      <path d="M7 10v12" />
      <path d="M17 2v20" />
      <path d="M17 2c2.2 1.5 3 4.2 3 7v3h-3" />
    </svg>
  ),
  ...
  coffee: (p) => (
    <svg {...base} {...p}>
      ...
      <path d="M8 4c0-1 1-1.5 1-2.5M12 4c0-1 1-1.5 1-2.5" />
      <path d="M4 22h16" />
    </svg>
  ),
  ...
  'message-circle': (p) => (
    <svg {...base} {...p}>
      <path d="M20 11.5a8 8 0 0 1-8.5 8 8.5 8.5 0 0 1-4-.9L3 20l1.4-4.2A8 8 0 1 1 20 11.5Z" />
  ...
  twitter: (p) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
      <path d="M18.9 3H22l-7.5 8.6L23 21h-6.9l-5.4-6.6L4.4 21H1.3l8-9.2L1 3h7.1l4.9 6.1L18.9 3Zm-1.2 16.2h1.7L7.4 4.7H5.6l12.1 14.5Z" />
    </svg>
  ),
}
